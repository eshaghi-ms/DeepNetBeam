...
model_data = dict()
model_data["beam_length"] = 2.
model_data["beam_width"] = 0.1#0.1
...
len_ratio = len_ratio if len_ratio > 0 else 1

ndata = 10000

numPtsU = 2**(num_refinements+4)
numPtsV = 2**(num_refinements+4)//len_ratio
...
for i in range(ndata):
    t1 = default_timer()
    traction[i,:], material[i,:], disp2D[i,:,:,:] = \
