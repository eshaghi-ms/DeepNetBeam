...
class Elast_TimoshenkoBeam(Elasticity2D_DEM_dist):
    ...
    def __init__(self, layers, train_opt, num_epoch_c, print_epoch_c, model_data_c, data_type_c):
        """
        """
        super().__init__(layers, train_opt, num_epoch_c, print_epoch_c, model_data_c, data_type_c)
...
def exact_disp(x, y):
    E = model_data["E"]
    nu = model_data["nu"]
    inertia = beam_width ** 3 / 12
    pei = pressure / (6 * E * inertia)
